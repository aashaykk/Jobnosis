    ...
    <main className='home'>
        <div className="interview-input-group">
            ...
            <div className="input-group">
                <p>Resume <small className='highlight'>(User resume and self description together for best results)</small></p>
            ...
            <div className="input-group">
                ...
                <textarea name="selfDescription" id="selfDescription" placeholder='Say something about yourself'></textarea>
            </div>
